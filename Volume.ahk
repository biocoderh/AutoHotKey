...
AppVolume("Spotify.exe").AdjustVolume(amount)
AppVolume("Sonixd.exe").AdjustVolume(amount)
...
AppVolume("Spotify.exe").ToggleMute()
AppVolume("Sonixd.exe").ToggleMute()
